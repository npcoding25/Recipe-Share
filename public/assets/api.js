...
//         "async": true,
//         "crossDomain": true,
//         "url": "https://webknox-recipes.p.rapidapi.com/recipes/search?offset=0&number=10" + `${intolerances}`+ `${food}`,
//         "method": "GET",
//         "headers": {
...
function searchRecipeIngredients() {
    ...
    var settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?number=10&ranking=1&ignorePantry=false&ingredients=" + `${foodItem}`,
        "method": "GET",
        "headers": {
